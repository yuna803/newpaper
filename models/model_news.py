...
class News(Base):
    ...
    description: Mapped[Optional[str]]= mapped_column(String(255), nullable=False,comment="新闻描述")
    content: Mapped[str] = mapped_column(String(255), nullable=False,comment="新闻内容")
    image: Mapped[Optional[str]] = mapped_column(String(255), nullable=False,comment="新闻图片")
    author: Mapped[Optional[str]] = mapped_column(String(255), nullable=False,comment="新闻作者")
